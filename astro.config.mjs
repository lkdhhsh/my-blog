...
// GitHub Pages 部署时由 CI 注入完整站点地址和子路径（见 .github/workflows/deploy.yml）
// 本地开发/构建时回退到 siteConfig.site_url 和根路径
const SITE_URL = process.env.SITE_URL || siteConfig.site_url;
